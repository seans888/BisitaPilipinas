<%-- 
    Document   : guardMain2
    Created on : Sep 25, 2019, 11:34:13 AM
    Author     : jlsolomon
--%>
...
<html>
    ...
    <body onload="myFunction()">
       ...
       <form>
            ...
            <input type="submit" value="Validate" onclick="form.action='validation';"
            ...
            <input type="submit" value="Submit" onclick="form.action='gviolation';">
        </form>
        </div>
        <div class="column2">
        <table>
