...
<html>
    ...
    background-size: 100% 100vh;">
        <a href="guardMain.html"><button type="button">Back</button></a>
        <br/><br/>
        <table>
            <tr>
                <th>Student id</th>
        ...
        <% 
            try{
                String id = "2004-40014";
                Class.forName("com.mysql.jdbc.Driver");
                Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/apcviolationsystem?" +
                "user=root&password=");
                PreparedStatement pst = conn.prepareStatement("Select stud_id, vio_studname, vio_studcourse, vio_nature,"
                            + "vio_comment, admin_id, vio_date from violation where admin_id=?");
                pst.setString(1, id);
