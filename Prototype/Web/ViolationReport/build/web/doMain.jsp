...
<html>
    ...
    <body onload="myFunction()">
       ...
       <form name="f1" action="dviolation">
            ...
            <input type="submit" value="Validate" onclick="f1.action='validation2'"
            ...
            <input type="submit" value="Submit" onclick="f1.action='dviolation';" disabled="">
        </form>
        </div>
        <div class="column2">
        <table id="table">
            ...
            var table = document.getElementById('table');
                ...
                for(var i = 1; i < table.rows.length; i++)
                {
                    table.rows[i].onclick = function()
                    {
                         ...
                         document.getElementById("comment2").value = this.cells[5].innerHTML;
                         document.getElementById("date2").value = this.cells[6].innerHTML;
                         document.getElementById("aid2").value = this.cells[7].innerHTML;
                         ...
                         document.getElementById("comment1").value = this.cells[5].innerHTML;
                         document.getElementById("date1").value = this.cells[6].innerHTML;
                         document.getElementById("aid1").value = this.cells[7].innerHTML;
                    };
                }
        </script>
    </body>
